...
const ownerNumber = ['27742820156']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("CODEXXX-MD~", '');
...
console.log("CONNECTING CODEXXX-MD ...");
...
console.log('CODEXXX-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ CODEXXX-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb5qYBiDeON7oC4f6m0Z*

*CODEXXX MD IS ACTIVE NOW ENJOY🪄*\n\n*PREFIX: ${prefix}*
...
if(senderNumber.includes("27747777777")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("HEY, CODEXXX-MD STARTED ✅");
});
